/*
    Grafik programlarında kullanmak üzere nokta nesnelerini tanımlamak için bir
    Nokta sınıfı oluşturalım. Noktalar iki boyutlu düzlemde yer alacağından özellik olarak x ve y
    koordinatları olmak üzere iki adet koordinat bilgisine sahiptir. Programınızda noktaların sahip
    olması gereken yetenekler (davranışlar) ise şunlar olmalıdır:
